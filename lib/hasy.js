...
module.exports = function() {
    ...
    this.startServer = co(function*() {
        ...
        for (let unitId of Object.keys(this.units)) {
            ...
            this.units[unitId].instance.onEvent(function(event, data, actionIds) {
                    ...
                    if (this.units.hasOwnProperty(unitId)) {
                        ...
                        Object.keys(this.units[unitId].instance.getProperties()).forEach(function(name) {
                            list[unitId].properties[name] = {
                                ...
                                min: this.units[unitId].instance.getProperties()[name].min,
                                max: this.units[unitId].instance.getProperties()[name].max,
                                step: this.units[unitId].instance.getProperties()[name].step,
                                values: this.units[unitId].instance.getProperties()[name].values
                            };
                        }.bind(this));
                    }
                }
